...
var region_init = function (_region_p, _region_c, _region_d, _region_p_default, _region_c_default, _region_d_default) {  
	...
	var default_v=document.getElementById("showp").value;  
    ...
    function region_d_change() {  
        var strsel = region_d.options[region_d.selectedIndex].text;
        document.getElementById("showd").value=strsel;
        document.getElementById("showd_id").value=region_d.value;
    ...
    function region_c_change() {  
        ...
        var strsel = region_c.options[region_c.selectedIndex].text;
        for (var i = 0; i < item.district.length; i++) {  
            option_items_add(region_d, item.district[i].id, item.district[i].name, null, i);  
        }  
        document.getElementById("showc").value=strsel;
        document.getElementById("showc_id").value=region_c.value;
    ...
    function region_p_change() {  
        ...
        var strsel = region_p.options[region_p.selectedIndex].text;
        for (var i = 0; i < item.city.length; i++) {  
            option_items_add(region_c, item.city[i].id, item.city[i].name, item.city[i], i);  
        }  
        document.getElementById("showp").value=strsel;
        document.getElementById("showp_id").value=region_p.value;
