...
layui.define(['code', 'element', 'table', 'util'], function(exports){
  ...
  layer.ready(function(){
    ...
    layui.data('layui', {
      key: 'notice_removeTree'
      ,remove: true
    });
    layui.data('layui', {
      key: 'notice_removeDDoS'
      ,remove: true
    });
    layui.data('layui', {
      key: 'notice_ddos'
    ...
    layer.open({
      ...
      ,shade: false
      ,offset: 'b'
      ,id: 'LAY_layerNotice' //设定一个id，防止重复弹出
      ,btn: ['了解详情', '朕知道了']
      ,btnAlign: 'c'
      ,moveType: 1 //拖拽模式，0或者1
      ,content: ['<div class="layui-text">'
        ,'<a href="http://fly.layui.com/jie/15827/" target="_blank" style="color: #fff;">layui 服务器持久稳定性众筹支持计划</a>'
        //,'由于<em>tree</em>和<em>layedit</em>均存在诸多不足，目前已经临时下线。宁缺毋滥，后续版本将会对它们进行重写，届时再重新开放。'
      ,'</div>'].join('')
