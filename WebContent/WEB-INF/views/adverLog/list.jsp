		...
		<div class="main" style="height:auto;">
			<div class="header">
				<div class="header-left">
					<p>你当前的位置：[广告管理]-[广告天数明细]</p>
				</div>
				<hr align="center" />
			</div>
			<div class="div_search">			
				用户：&nbsp;<input type=text class="input" value="${search_name }" name="search_name" style="width:160px;"/>&nbsp;&nbsp;
					...
					<tbody>
						...
						<c:forEach items="${logList}" var="data">
							<tr>
								...
								<td>${data.id}</td>
            					<td>
            						<c:if test="${data.adminUser.loginname!=null}">
            							${data.adminUser.loginname}
            						</c:if>
            					</td>
            					<td>${data.adminUser.levelname}</td>
            					<td>${data.unionDaycounts}</td>
            					<td>${data.discript }</td>
