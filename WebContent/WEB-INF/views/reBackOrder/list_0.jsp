...
<form id="searchOrChangePage"><!-- 用于提交查询条件，或者翻页的一些数据信息； -->
	...
	<div class="tab">
    	<h4 class="tabh4">
    		<c:if test="${backState==null||backState==10 }">
            <span class="current">退单申请</span>
            <span onclick="javascript:window.location.href='list?backState=20';">已审核</span>
            </c:if>
            <c:if test="${backState!=null&&backState==20 }">
            <span onclick="javascript:window.location.href='list?backState=20';">退单申请</span>
                	...
                	<table>
                        ...
                        <tbody>
                        	...
                        	<tr class="default">
                                ...
                                <td width="12%">
                                <c:if test="${userLevel<95 }">
                                <a href="javascript:window.location.href='edit?id=${item.id }';">审核</a> / 
                                </c:if>
                                <a href="javascript:window.location.href='detail?id=${item.id }';">详情</a></td>
                            </tr>
                            </c:forEach>
                        </tbody>
                    </table>
