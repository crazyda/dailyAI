					...
					<tbody>
						<c:forEach items="${messagelist}" var="message">
							<tr>
								...
								<td>${message.id }</td>
								<td>${message.title }</td>
								<td><img src="<%=basePath%>${message.cover }" style="width:80px;height:80px;"/></td>
...
<script>
	...
	function addmessage(){
		window.location.href="editImageText.action";
		}
	function del(id){
		window.location.href="del.action?ids="+id;
	}
