			...
			<div class="container">
				...
				<script type="text/javascript">
					...
					function subCheck(){
						...
						$.post("taoke/pids/distributePid",data,function(result){
								if(result==0){
									alert("该用户已有PID!");
								}
								else{
									location.href="taoke/pids/toPidList";
 								}
						});
					}
						...
						$("#s1").change(function(){
							...
							console.log(s1);
								if($(s1).val()>1){
									$.getJSON("taoke/pids/changeSelect",{id:$(s1).val()},function(data){
										$(s2).children().remove();
						...
						$("#s2").change(function(){
							...
							var s3=$("#s3");
								if($(s2).val()>1){
									$.getJSON("taoke/pids/changeSelect",{id:$(s2).val()},function(data){
