							...
							$(function(){
								...
								$("#seek").keyup(function(ee){
									...
									$("#level").change(function(){
											...
											if(level>1){
												$.getJSON("taoke/pid/findParentTkldPid",{level:level},function(data){
									...
									$("#pid").blur(function(){
										...
										if(pid.length==30){
											...
											$.post("taoke/pid/checkPid",{pid:pid},function(data){
