...
<div class="main" style="height:auto;">
    ...
    <div class="pageColumn">
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <tbody>
            <c:forEach items="${pageResult.result }" var="note">
                <tr>
                    <td><input type="checkbox" name="code_Value" value="${note.id }"/></td>
                    <td>${note.id }</td>
                    <td>${note.sendUsers.name}</td>
                    <td>
                    ...
                    <td>
                        <div align="center">
                            <span class="STYLE4">
                                <span onclick="check('${note.id }');" style="cursor: pointer;">
                                    <img src="<%=basePath%>constant/tab/images/edt.gif" width="16" height="16"/>审核
                                </span>
                                <script>
                                    function check(checkGoodsId) {
                                        location.href = "<%=basePath%>goodsCheck/detailOfChangeNoteMall?checkId=" + checkGoodsId;
                                    }
                                </script>
                            </span>
                        </div>
