        ...
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <c:forEach items="${pageResult.result }" var="each">
                <tr>
                    ...
                    <td>
                        <fmt:formatDate value="${each.addedTime }" pattern="yyyy-MM-dd HH:mm:ss"/>--
                         <fmt:formatDate value="${each.shelvesTime  }" pattern="yyyy-MM-dd HH:mm:ss"/>
                    </td>
                            ...
                            <span class="STYLE4">
                                ...
                                <script>
                                    function check(checkGoodsId) {
                                        location.href = "<%=basePath%>goodsCheck/detailOfLockMall?checkGoodsId=" + checkGoodsId;
                                    }
                                </script>
                            </span>
                        </div>
