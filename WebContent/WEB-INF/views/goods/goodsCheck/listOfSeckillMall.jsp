            ...
            <c:forEach items="${pageResult.result }" var="each">
                <tr>
                    ...
                    <td>
                       ...
                       <c:forEach items="${each.times }" var="times">
                            ...
                            <span class="STYLE4">
                                ...
                                <script>
                                    function check(checkGoodsId) {
                                        location.href = "<%=basePath%>goodsCheck/detailOfSeckillMall?checkGoodsId=" + checkGoodsId;
                                    }
                                </script>
                            </span>
                        </div>
