            ...
            <div class="r_con_wrap">
                <div class="r_con_form">
                    ...
                    <div class="rows">
                        <label>商品名称：</label>
                        <span class="input">
                            <label>${reGoodsOfChangeMall.snapshotGoods.name}</label>
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>封面图片：</label>
                        <span class="input">
                            <img src="${RESOURCE_LOCAL_URL}${reGoodsOfChangeMall.snapshotGoods.coverPicOne}" style="width: 150px;height: 150px;;">
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                    ...
                    <div class="rows">
                        <label>商品标签：</label>
                        <span class="input">
                            <label>${reGoodsOfChangeMall.snapshotGoods.lablesString}</label>
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>市场价：</label>
						<span class="input">
                            <label>${reGoodsOfChangeMall.displayPrice}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                <%--基础商品信息结束--%>

                    <c:if test="${reGoodsOfChangeMall.isNoStandard}">
                        <div class="rows">
                            <label>库存：</label>
						<span class="input">
                            <label>${reGoodsOfChangeMall.noStandardRepertory}</label>
			 			</span>
                            <div class="clear"></div>
                        </div>
                        <div class="rows">
                            <label>单价：</label>
						<span class="input">
                            <label>${reGoodsOfChangeMall.noStandardPrice}</label>
			 			</span>
                            <div class="clear"></div>
                        </div>
                    ...
                    <div class="rows">
						...
						<span class="input">
                            <dd>
                                ...
                                <span>包邮</span>
                                ${reGoodsOfChangeMall.transportationType==2?"<input type=radio name='transportationType' value='2' checked/>":"<input type=radio name='transportationType' value='2'/>"}
                                <span style="margin-right:0;">邮费</span>
                                <input type="text" name="transportationPrice" class="txt" value="${reGoodsOfChangeMall.transportationPrice}">
                                <span>元</span>
                                ${reGoodsOfChangeMall.transportationType==3?"<input type=radio name='transportationType' value='3' checked/>":"<input type=radio name='transportationType' value='3'/>"}
                                <span>到店消费</span>
                                ${reGoodsOfChangeMall.transportationType==4?"<input type=radio name='transportationType' value='4' checked/>":"<input type=radio name='transportationType' value='4'/>"}
                                <span>上门自取</span>
                            </dd>
			 			</span>
                        <div class="clear"></div>
                    ...
                    <div class="rows">
                        <label>商家想要：</label>
						<span class="input">
                            <label>${reGoodsOfChangeMall.want}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>马上参与交换：</label>
						<span class="input">
                            <label>${reGoodsOfChangeMall.isChange==1?'是':'否'}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>起换数量：</label>
						<span class="input">
                            <label>${reGoodsOfChangeMall.startQuantity}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                    ...
                    <div class="rows">
                        <label></label>
						<span class="input">
							<input type="button" value="审核通过" onclick="pass(${reGoodsOfChangeMall.id},true);" style="color:#fff; font-size:1.0rem; line-height:2.5rem; width:6.0rem; background:#0e93d8; border-radius:3px; cursor:pointer;"/>
							<input type="button" value="审核不通过" onclick="pass(${reGoodsOfChangeMall.id},false);" style="color:#fff; font-size:1.0rem; line-height:2.5rem; width:6.0rem; background:#0e93d8; border-radius:3px; cursor:pointer;"/>
						</span>
                        <div class="clear"></div>
                        <script>
                            function pass(goodsId, isPass) {
                                var d = $(".checkDesc").val();
                                $.post("checkOfChangeMall", {"goodsId": goodsId, "checkDesc": d, "isPass": isPass}, function (data) {
                                    alert(data.message);
                                    location.href = "listOfChangeMall";
                                });
                            }
                        </script>
                    </div>
