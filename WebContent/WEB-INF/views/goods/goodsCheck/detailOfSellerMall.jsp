            ...
            <div class="r_con_wrap">
                <div class="r_con_form">
                    ...
                    <div class="rows">
                        <label>商品名称</label>
                        <span class="input">
                           <label>${reGoodsOfSellerMall.snapshotGoods.name}</label> 
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>封面图片：</label>
                        <span class="input">
                           <img src="${RESOURCE_LOCAL_URL}${reGoodsOfSellerMall.snapshotGoods.coverPicOne}" style="width: 150px;height: 150px;;">
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div id="slider" class="rows">
                        ...
                        <span  class="input">
                            <c:forEach  items="${goodsOfBase.listOfDescriptionPics}" var="each">
                                  <a href="${RESOURCE_LOCAL_URL}${each}"><img  src="${RESOURCE_LOCAL_URL}${each}" style="width: 100px;height: 100px;display: inline-block"></a>
                            </c:forEach>
                        </span>
                    ...
                    <div class="rows">
                        <label>商品标签：</label>
                        <span class="input">
                            <label>${reGoodsOfSellerMall.snapshotGoods.lablesString}</label>
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>市场价：</label>
						<span class="input">
                            <label>${reGoodsOfSellerMall.displayPrice}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                <%--基础商品信息结束--%>
                    ...
                    <c:if test="${reGoodsOfSellerMall.isNoStandard}">
                        <div class="rows">
                            <label>库存：</label>
						<span class="input">
                            <label>${reGoodsOfSellerMall.noStandardRepertory}</label>
			 			</span>
                            <div class="clear"></div>
                        </div>
                        <div class="rows">
                            <label>单价：</label>
						<span class="input">
                            <label>${reGoodsOfSellerMall.noStandardPrice}</label>
			 			</span>
                            <div class="clear"></div>
                        </div>
                        <div class="rows">
                            <label>红包可抵扣：</label>
						<span class="input">
                            <label>${reGoodsOfSellerMall.noStandardRedPaper}</label>
			 			</span>
                            <div class="clear"></div>
                        </div>
                    </c:if>
                    ...
                    <div class="rows">
                        <label>上架时间：</label>
						<span class="input">
                            <label>${reGoodsOfSellerMall.addedTime}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                        <label>下架时间：</label>
						<span class="input">
                            <label>${reGoodsOfSellerMall.shelvesTime}</label>
			 			</span>
                        <div class="clear"></div>
                    </div>
                    <div class="rows">
                    ...
                    <div class="rows">
                        <label></label>
						<span class="input">
							<input type="button" value="审核通过" onclick="pass(${reGoodsOfSellerMall.id},true);" style="color:#fff; font-size:1.0rem; line-height:2.5rem; width:6.0rem; background:#0e93d8; border-radius:3px; cursor:pointer;"/>
							<input type="button" value="审核不通过" onclick="pass(${reGoodsOfSellerMall.id},false);" style="color:#fff; font-size:1.0rem; line-height:2.5rem; width:6.0rem; background:#0e93d8; border-radius:3px; cursor:pointer;"/>
						</span>
                        <div class="clear"></div>
                        <script>
                            function pass(goodsId, isPass) {
                            	var name = $("input[name='transportationType']:checked").val();
                            
                                var d = $(".checkDesc").val();
                                $.post("checkOfSellerMall", {"goodsId": goodsId, "checkDesc": d, "isPass": isPass,"transportationType":name}, function (data) {
                                    alert(data.message);
                                    location.href = "listOfSellerMall";
                                });
                            }
                        </script>
                    </div>
