                            ...
                            <div align="center">
										<span class="STYLE4">
											<span onclick="onPut('${each.id }');" style="cursor: pointer;">
												<img src="<%=basePath%>constant/tab/images/del.gif" width="16" height="16"/>下架
											</span>
											<script>
												function onPut(data) {
                                                    ...
                                                    $.post("<%=basePath%>reMallGoods/unPut", {"mallGoodsId": data, "mallId": "${goodsType}"}, function (data) {
                                                        ...
                                                        location.href = "<%=basePath%>reMallGoods/sellerMallList?goodsType=" + goodsType;
                                                    });
														});
                        ...
                        <c:if test="${each.isChecked!=null }">
                            <div>
                            	...
                            	<div  align="center" style="margin-top: 8px">
                            		<span class="STYLE4">
										<span onclick="promote('${each.id}');" style="cursor: pointer; margin-top: 5px;">
											<img src="<%=basePath%>constant/tab/images/22.gif" width="16" height="16"/>推广
										</span>
										
										<script>
											function promote(id){
												location.href="<%=basePath%>reMallGoods/promotePage?goodsId=" + id;
											}
										</script>
									</span>
                            	</div>
