    ...
    <form action="put">
        ...
        <div class="indpdt_mall_con default_con">
            ...
            <div class="list">
            	...
            	<dl class="stock">
                    <dt><font color="red">*</font>秒杀价格</dt>
                    <dd>
                        <input type="text" name="price" class="txt"  placeholder="请输入秒杀活动的价格" value="" style="width: 20%">
                    </dd>
                </dl>
                <dl class="stock">
                    <dt><font color="red">*</font>发布数量</dt>
                    <dd>
                        <input type="text" name="stock" class="txt" placeholder="请输入秒杀活动商品的数量" value="" style="width: 20%">
                    </dd>
                </dl>
                 <dl class="status">
                    ...
                    <dd class="seckillTimes">
                        <c:forEach items="${timesList }" var="times">
                            <input type="checkbox" name="secondskilltimeId" class="times"
