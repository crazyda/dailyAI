    ...
    <form action="put" id="saveForm" method="post">
        ...
        <div class="indpdt_mall_con default_con">
            ...
            <div class="list">
            	...
            	<dl class="stock">
                    <dt><font color="red">*</font>积分兑换</dt>
                    <dd>
                        <input type="text" name="score" class="txt"  placeholder="请输入积分免费兑换的数量" value=""  style="width: 20%">
                    </dd>
                </dl>
                <dl class="stock">
                    <dt><font color="red">*</font>发布数量</dt>
                    <dd>
                        <input type="text" name="stock" class="txt" placeholder="请输入积分兑换的商品的数量" value="" style="width: 20%">
                    </dd>
                </dl>
                 <dl class="stock">
