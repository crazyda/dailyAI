...
<div class="main" style="height:auto;">
    ...
    <div class="div_search">
        <form id="searchOrChangePage" method="post" action="localSpecialList">
												...
												function onPut(data) {
													...
													layer.confirm('下架该商品会导致该商品所有优惠价一同下架', {icon: 3, title:'提示'}, function(index){
														...
														$.post("<%=basePath%>reMallGoods/unPut", {"mallGoodsId": data, "mallId": "${goodsType}"}, function (data) {
	                                                        ...
	                                                        location.href = "<%=basePath%>reMallGoods/localSpecialList?goodsType=" + goodsType;
	                                                    });
													});
