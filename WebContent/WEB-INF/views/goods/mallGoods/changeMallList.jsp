...
<div class="main" style="height:auto;">
    ...
    <div class="div_search">
        <form id="searchOrChangePage" method="post" action="changeMallList">
											...
											<script>
												function onPut(data) {
                                                    $.post('<%=basePath%>reMallGoods/unPut', {"mallGoodsId": data, "mallId": "${goodsType}"}, function (data) {
                                                        ...
                                                        location.href = '<%=basePath%>reMallGoods/changeMallList?goodsType=' + goodsType;
                                                    });
