...
<div class="main" style="height:auto;">
    ...
    <div class="pageColumn">
        ...
        <input type="hidden" name="code_Value" value="${cashpoint.adminUser.id }"/>
            ...
            <th width="5%" style="height:50px;">用户名</th>
            <th width="12%">金额</th>
            <th width="12%">变动时间</th>
           	<th width="12%">状态</th>
            <th width="18%">说明</th>
            ...
            <c:forEach items="${pageResult.result }" var="cashpoint">
                <tr>
                    ...
                    <td>${cashpoint.adminUser.loginname }</td>
                    ...
                    <td>
                    <c:choose>
                    	<c:when test="${cashpoint.type==1 }">已确认金额</c:when>
                    	<c:when test="${cashpoint.type==-1 }">未确认金额</c:when>
