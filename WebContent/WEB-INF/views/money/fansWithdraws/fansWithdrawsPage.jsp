    ...
    <div style="margin-left:10px;">
        ...
        <script>
            ...
            if(confirm("确认提交审核？确认操作后数据无法恢复！请谨慎操作")){
                $.post('<%=basePath%>fansWithdraws/verifying',$(".detail_form").serialize(),function(data){
                    alert(data.message);
                    location.href="<%=basePath%>/fansWithdraws/fansExamineList";
