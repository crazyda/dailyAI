    ...
    <div class="pageColumn">
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <c:forEach items="${pageResult.result }" var="wd">
                <tr>
                    <td><input type="checkbox" name="code_Value" value="${wd.id }"/></td>
                    ...
                    <td>
                        <div align="center">
                            <span class="STYLE4">
                                ...
                                <script>
                                   <%--  function pay(data) {
                                        $.post("<%=basePath%>sellerWithdraw/confirmSellerWithdraw?", {"recordId": data}, function (data) {
                                            alert(data.message);
                                            location.href = "<%=basePath%>sellerWithdraw/confirmSellerWithdrawList";
                                        });
                                    } --%>
                                    function pay(data){
                                    	location.href="<%=basePath%>sellerWithdraw/getsellerPayPage?Id="+data;
                                    }
