    ...
    <div class="pageColumn">
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <c:forEach items="${pageResult.result}" var="cashrecord">
                ...
                <tr>
                    <td><input type="checkbox" name="code_Value" value="${cashrecord.usersByUserId.id }"/></td>
                    <td>${cashrecord.usersByUserId.id}</td>
                    <td>${cashrecord.money}</td>
                    <td>${cashrecord.remark }</td>
                    <td>${cashrecord.afterMoney }</td>
                    <td>
                     <fmt:formatDate value="${cashrecord.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/>
