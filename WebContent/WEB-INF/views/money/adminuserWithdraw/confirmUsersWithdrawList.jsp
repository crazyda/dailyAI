        ...
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <c:forEach items="${pageResult.result }" var="Remoney">
                <tr>
                    ...
                    <td>
                    <c:choose>
                    	<c:when test="${Remoney.status==0 }">未支付</c:when>
                        ...
                        <div align="center">
                            <span class="STYLE4">
                                ...
                                <script>
                                    ...
                                    function pay(data){
                                    	location.href="<%=basePath%>confirmUsersWithdraw/getUserPayPage?Id="+data;
                                    }
                                    function changeRecord(userId){
                                        location.href="<%=basePath%>confirmUsersWithdraw/getCashMoneyChangeRecord?userId="+userId;
                                    }
                                </script>
                            </span>
                        </div>
