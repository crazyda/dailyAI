...
<div class="main" style="height:auto;">
    ...
    <div class="pageColumn">
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <th width="5%" style="height:50px;">提现用户</th>
            <th width="10%">提现金额</th>
            <th width="5%">手续费</th>
            <th width="10%">提现时间</th>
            <th width="15%">审核状态</th>
            ...
            <c:forEach items="${pageResult.result }" var="withdraw">
             <input type="hidden" name="code_Value" value="${withdraw.adminUser.id }"/>
                <tr>
                    ...
                    <td>
                    <c:choose>
                    <c:when test="${withdraw.state==0}">待审核</c:when>
                    <c:when test="${withdraw.state==-1}">审核不通过</c:when>
                    ...
                    <td>
                            ...
                            <span class="STYLE4">
	                    			...
	                    			<u><span onclick="check('${withdraw.id }');" style="cursor: pointer;">
	                                  		  审核
	                                </span></u>
                                ...
                                <script>
                                    function check(data){
                                        location.href="<%=basePath%>AdminwithdrawReview/WithdrawCheckPage?Id="+data;
                                    }
