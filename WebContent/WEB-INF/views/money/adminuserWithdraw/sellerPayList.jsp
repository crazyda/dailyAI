             ...
             <input type="hidden" name="code_Value" value="${withdraw.adminUser.id }"/>
                <tr>
                    ...
                    <td>
                            <div align="center">
                            <span class="STYLE4">
	                             <span onclick="pay('${withdraw.id }');"  style="cursor: pointer;">
                                    支付
                                </span>&nbsp;&nbsp;
    ...
    <div style="margin-top: 50px;margin-bottom: 50px;text-align: center;margin-left: 20px;">
       ...
       $("#s").click(function(){
    	 	 console.log($("#s").prop("checked"))
       		...
       		<%-- 	<%=basePath%>confirmUsersWithdraw/fansPay?Ids="+data; --%>
       			...
       			function pay(data){
       				...
       				$.ajax({
   						async:false,
						url:"<%=basePath%>AdminwithdrawReview/sellerPay",
						data:data,
						 dataType: "json",
						success:function(data){
							if(data.status!="1"){
								...
								alert(data.message);
								location.href="<%=basePath%>AdminwithdrawReview/getSellerPayList";
							}
						}
					}); 
       			}
