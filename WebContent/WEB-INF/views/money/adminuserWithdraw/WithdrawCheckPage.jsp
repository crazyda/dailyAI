    ...
    <div style="margin-left:10px;">
        ...
        <form class="detail_form" action="AdminwithdrawReview">
            ...
            <dl>
                <dt>是否支付：</dt>
                <dd>
                    <input type="radio" name="pass" id="pass" value="10">
            ...
            <dl>
                ...
                <dd><textarea placeholder="请输入驳回说明" name="remark"></textarea></dd>
            </dl>
            <div class="check_btn"><input type="button" value="支付" onclick="submitForm()"></div>
            
            <script>
            function submitForm(){
                $.post("WithdrawCheck",$(".detail_form").serialize(),function(data){
                    alert(data.message);
