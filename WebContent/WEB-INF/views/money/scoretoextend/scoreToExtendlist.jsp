...
<div class="main" style="height:auto;">
    <div class="header">
        <div class="header-left">
            <p>你当前的位置：[资金管理]-[商家积分推广]</p>
        </div>
        <div class="header-right">
            <div class="header-right-cell-line"></div>
            <div class="header-right-cell" onclick="javascript:location.href='<%=basePath%>sellerWithdraw/edit'" style="cursor: pointer;">
    ...
    <div class="pageColumn">
        <table class="list" style="width:98%;margin:0 auto;">
            ...
            <th width="10%">积分券名称</th>
            <th width="10%">积分券面额</th>
            <th width="18%">积分券对应积分</th>
            <th width="18%">有效时间</th>
            <th width="18%">推广时间</th>
            <th width="18%">操作</th>
            </thead>
            ...
            <c:forEach items="${pageResult.result }" var="each">
                <tr>
                    ...
                    <td>${each.score }</td>
                    <td>
                        <fmt:formatDate value="${each.validityTime }" pattern="yyyy-MM-dd HH:mm:ss"/>
                    </td>
                    <td>
							...
							<span class="STYLE4"> 
								...
								<script>
									function del(deleteId){
										$.post('<%=basePath%>sellerWithdraw/_delete',{id:deleteId},function(data){
											location.reload();
										});
									}
									function edit(editId){
										location.href="<%=basePath%>sellerWithdraw/edit?id="+editId;
