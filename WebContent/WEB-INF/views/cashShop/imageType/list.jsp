		...
		<div class="main" style="height:auto;">
			<div class="header">
				<div class="header-left">
					<p>你当前的位置：[商城管理]-[商城图文类别管理]</p>
				</div>
				<div class="header-right">
					<div class="header-right-cell" onclick="createImageType();" style="cursor: pointer;">
				...
				<table class="list" style="width:98%;margin:0 auto;">
					...
					<c:forEach items="${slst }" var="type">
						<tr>
							...
							<td>
            <span class="STYLE4">
            <span onclick="editImageType('${type.id }');" style="cursor: pointer;">
            <img src="<%=basePath%>constant/tab/images/edt.gif" width="16" height="16"  />编辑</span>&nbsp; &nbsp;
            <span style="cursor: pointer;" onclick="if(!confirm('您确认要删除此数据吗?删除后数据不能恢复!'))return false; else deleteImageType('${type.id }');"><img src="<%=basePath%>constant/tab/images/del.gif" width="16" height="16" />删除</span>
            </span></div></td>
						</tr>
						</c:forEach>
					</tbody>
