...
<body>
	<form action="<%=basePath%>cashShop/goodsLable/list" method="post">
		<div class="main" style="height:auto;">
			<div class="header">
				<div class="header-left">
					<p>你当前的位置：[商城管理]-[商品标签管理]</p>
				</div>
				<hr align="center" />
			</div>
			...
			<div class="div_search">
				...
				<div class="header-right" style="margin-top: -60px;margin-left: 100px">
					<div class="header-right-cell" onclick="addLable()" style="cursor: pointer;">
			...
			<table class="list" style="width:98%;margin:0 auto;">
					<thead>
						...
						<th width="10%">商品标签名称</th>
						<th width="9%">基本操作</th>
					</thead>
					<tbody>
						<c:forEach items="${list }" var="lable">
							<tr>
								<td><input type="checkbox" name="code_Value" value="${lable.id }" /></td>
								<td>${lable.id }</td>
								<td>${lable.name }</td>								
								<td>							
								<div align="center">
									<span class="STYLE4"> <span onclick="editLable('${lable.id }');" style="cursor: pointer;"> <img src="<%=basePath%>constant/tab/images/edt.gif" width="16" height="16" />编辑
									</span> <span style="cursor: pointer;" onclick="if(!confirm('您确认要删除此数据吗?删除后数据不能恢复!'))return false; else del('${lable.id }');"><img src="<%=basePath%>constant/tab/images/del.gif" width="16" height="16" />删除</span>
									</span>
								</div>
