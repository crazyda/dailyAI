 ...
 */
public class ReGoodsOfBaseEditRecord extends ReBaseDomain {

    private String sign = UUID.randomUUID().toString();//商品的唯一编号；
    private String name;//商品名称；
    private ReGoodsOfBase reGoodsOfBase; 
    ...
    private String launchMall = "0000000";//该商品投放到哪个商城；使用六个字符的组成的字符串表示；
    //用来页面循环商品简述图
    private List<String> pics;
   
    private Integer sellerMallSalesVolume;  //销量
    
    private Integer scoreMallSalesVolume;

	private Integer  localSpecialtyMallSalesVolume;

	private Integer  seckillMallSalesVolume;
    ...
    public String getLablesString() {
        ...
        if(StringUtils.isNotBlank(this.lables)){
	        try {
    ...
    public Integer getLocalSpecialtyMallSalesVolume() {
		return localSpecialtyMallSalesVolume;
	}
    ...
    public ReGoodsOfBase getReGoodsOfBase() {
		return reGoodsOfBase;
	}
	...
	public Integer getScoreMallSalesVolume() {
		return scoreMallSalesVolume;
	}

    

    public Integer getSeckillMallSalesVolume() {
		return seckillMallSalesVolume;
	}
    ...
    public Integer getSellerMallSalesVolume() {
		return sellerMallSalesVolume;
	}
    ...
    public void setLocalSpecialtyMallSalesVolume(
			Integer localSpecialtyMallSalesVolume) {
		this.localSpecialtyMallSalesVolume = localSpecialtyMallSalesVolume;
	}
    ...
    public void setReGoodsOfBase(ReGoodsOfBase reGoodsOfBase) {
		this.reGoodsOfBase = reGoodsOfBase;
	}
    ...
    public void setScoreMallSalesVolume(Integer scoreMallSalesVolume) {
		this.scoreMallSalesVolume = scoreMallSalesVolume;
	}

    public void setSeckillMallSalesVolume(Integer seckillMallSalesVolume) {
		this.seckillMallSalesVolume = seckillMallSalesVolume;
	}
    ...
    public void setSellerMallSalesVolume(Integer sellerMallSalesVolume) {
		this.sellerMallSalesVolume = sellerMallSalesVolume;
	}
