...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  public List<String> infos; // required
  /**
   * 
   * @see ResponseState
   */
  ...
  public Response(Response other) {
    ...
    if (other.isSetInfos()) {
      List<String> __this__infos = new ArrayList<String>(other.infos);
  ...
  public Response setStudentID(int studentID) {
    this.studentID = studentID;
    setStudentIDIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<String> getInfosIterator() {
    return (this.infos == null) ? null : this.infos.iterator();
  }

  public void addToInfos(String elem) {
    if (this.infos == null) {
   ...
   * @see ResponseState
   */
  public Response setState(ResponseState state) {
    this.state = state;
    return this;
  }
  ...
  private static class ResponseStandardScheme extends StandardScheme<Response> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.infos = new ArrayList<String>(_list0.size);
                String _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Response struct) throws org.apache.thrift.TException {
      ...
      if (struct.infos != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.infos.size()));
          for (String _iter3 : struct.infos)
          {
      ...
      if (struct.isSetInfos()) {
        {
          ...
          for (String _iter4 : struct.infos)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.infos = new ArrayList<String>(_list5.size);
          String _elem6;
