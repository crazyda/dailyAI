 ...
 */
@Controller
@RequestMapping("/taoke/pids/")
public class PidManageOneAction extends BaseAction {

	@NeedPermission(permissionName = "用户--留言", classifyName = "淘客管理")
	@IsItem(firstItemName = "淘客管理", secondItemName = "用户--留言")
	...
	public String findSharePartnerList(HttpServletRequest request) {
		...
		return "taoke/pidManages/sharePartnerList";
	}

	@NeedPermission(permissionName = "PID--列表", classifyName = "淘客管理")
	@IsItem(firstItemName = "淘客管理", secondItemName = "PID--列表")
	@RequestMapping("toPidList")
	public String findTkldPidList(HttpServletRequest request) {
		tkldPidService.findTkldPidList(request);
		return "taoke/pidManages/list";
	}

	@NeedPermission(permissionName = "PID--查询", classifyName = "淘客管理")
	@IsItem(firstItemName = "淘客管理", secondItemName = "PID--查询")
	...
	public String toSearchPid(HttpServletRequest request) {
		...
		return "taoke/pidManages/searchPid";
	}

	@NeedPermission(permissionName = "新增--PID", classifyName = "淘客管理")
	@IsItem(firstItemName = "淘客管理", secondItemName = "新增--PID")
	@RequestMapping("toAddJsp")
	public String toAddJsp(HttpServletResponse response) {
		return "taoke/pidManages/addPid";
	}
	...
	public String todistributePid(Integer id, HttpServletRequest request) {
		...
		if (tkldPid.getLevel() == 1) {
			...
			return "taoke/pidManages/distributePid";
		}
		return "taokes/pidManages/distributePartnerPid";
	}
	...
	public String toEditPid(Integer id, HttpServletRequest request) {
		...
		if (tkldPid.getLevel() == 2) {
			request.setAttribute("tkldPid", tkldPid);
			return "taoke/pidManages/distributePartnerPid";
		}
	...
	@NeedPermission(permissionName = "补充--合伙人", classifyName = "淘客管理")
	@IsItem(firstItemName = "淘客管理", secondItemName = "补充--合伙人")
	@RequestMapping("partnerList")
	public String partnerList(HttpServletRequest request) {
		partnerInformService.findAll(request);
		return "taoke/pidManages/partnerList";
	}
	...
	public void addPartner(Integer id, HttpServletRequest request,
		...
		try {
			printWriter = response.getWriter();
			boolean flag = partnerInformService.addPartner(id);//到这里就是false
			result = flag == true ? "1" : "0";
			printWriter.print(result);
			printWriter.flush();
			printWriter.close();
	...
	public String partnerDetail(Integer id, HttpServletRequest request) {
		...
		return "taoke/pidManages/partnerDetail";
	}
	...
	public String findNextLevelByUserId(HttpServletRequest request,Integer currentPage, Integer pageSize,Integer userId) {
		...
		try {
		 ...
		 if (currentPage == null || currentPage < 1) {
	      ...
	      return "taoke/pidManages/fansDetails";
